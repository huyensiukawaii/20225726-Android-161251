...
class StudentDatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        // Tên các cột tương ứng với data class Student
    ...
    override fun onCreate(db: SQLiteDatabase) {
        // Tạo bảng với MSSV là khóa chính
    ...
    // Cập nhật sinh viên (Dựa trên MSSV)
    fun updateStudent(student: Student): Int {
        ...
        // Cập nhật dòng có MSSV trùng khớp
        val result = db.update(TABLE_NAME, values, "$COLUMN_MSSV = ?", arrayOf(student.mssv))
        return result
    }

    // Xóa sinh viên (Dựa trên MSSV)
